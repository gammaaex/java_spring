...
class ScoreAnalyzer6
{
          ...
          IOException
  {
    ...
    ArrayList<Integer> questionList = new ArrayList<>(); //重複しない問題番号のリスト
    ArrayList<String> StudentList = new ArrayList<>(); //ソートするための学生番号を持つリスト
